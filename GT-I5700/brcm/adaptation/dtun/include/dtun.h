...
#define DTUN_DEFAULT_DEV_NAME "GT-I5700"
...
#define BRCM_PROPERTY_BT_FUNCTION_ACTIVATED "service.brcm.bt.funct_activated"
...
typedef struct
{
    tDTUN_HDR hdr;
    DTUN_PATH file_path_name;
} tDTUN_METHOD_OP_SET_DEFAULT_PATH;
...
{
    tDTUN_HDR hdr;
    // KJH 20100105 :: Resolved device name length issue. "opp-NameOwnerChanged signal" (IMS 282595) (Henry)
    //char      bdname[128];
...
typedef union
{
    ...
    tDTUN_METHOD_OP_SET_DEFAULT_PATH    op_set_default_path;
} tDTUN_DEVICE_METHOD;
...
typedef union
{
    ...
    tDTUN_SIG_OP_SET_DEFAULT_PATH    op_sig_set_default_path;
