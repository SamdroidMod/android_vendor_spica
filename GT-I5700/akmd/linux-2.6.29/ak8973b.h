...
#define AKECS_REG_ST            0xC0    /* Status */
#define AKECS_REG_MS1           0xE0    /* Mode setting */

#define AKECS_REG_TMPS          0xC1    /* Temperature reading - TMPS code values */

/* Readings: 00 to FF values */
#define AKECS_REG_H1X           0xC2
#define AKECS_REG_H1Y           0xC3
#define AKECS_REG_H1Z           0xC4

/* Offsets: 7F 7E ... 01 00 80 81 ... FE FF (00 = -0 & 80 = +0) (156.25uV step) */
#define AKECS_REG_HXDA          0xE1
#define AKECS_REG_HYDA          0xE2
#define AKECS_REG_HZDA          0xE3

/* Gains: 0 to F (26.8 to 32.8) (15 steps) */
#define AKECS_REG_HXGA          0xE4
#define AKECS_REG_HYGA          0xE5
#define AKECS_REG_HZGA          0xE6

// AKECS EEPROM address
#define AKECS_EEP_ETS           0x62    /* Offset for temperature */
#define AKECS_EEP_EVIR          0x63    /* */
#define AKECS_EEP_EIHE          0x64    /* */
#define AKECS_EEP_ETST          0x65    /* For testing */
#define AKECS_EEP_EHXGA         0x66    /* X gain */
#define AKECS_EEP_EHYGA         0x67    /* Y gain */
#define AKECS_EEP_EHZGA         0x68    /* Z gain */
#define AKMIO                   0xA1
